<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="专家发消息界面.aspx.cs" Inherits="datacut.专家发消息界面" %>
											...
											<td vAlign="top" bgColor="white" width="700" height="500">
												<table style="width: 552px">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="TypeList" runat="server" Height="20px" Width="100px" OnSelectedIndexChanged="TypeList_SelectedIndexChanged" AutoPostBack="True"> 
                                                                <asp:ListItem>公共</asp:ListItem>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="SupplierList" runat="server" Height="20px" Width="100px" AutoPostBack="True" Enabled="False"> 
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                            ...
                                                            <asp:TextBox ID="Content" runat="server" Height="136px" Width="430px" TextMode="MultiLine"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:Button ID="SendButton" runat="server" OnClick="SendButton_Click" Text="发送" />
