<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="专家打分界面.aspx.cs" Inherits="datacut.专家打分界面" %>
    ...
    var gradeBox = {
        create: function () {
            ...
            con.innerHTML = '<div style = "width:370px;display:none;position:absolute;background:#fff;border:1px solid #aacbff;box-shadow:0px 0px 15px #aaa;border-radius:10px;z-index:101;padding:5px;" id = "gradeBox">' +
                '<div style = "width:100%;height:30px;"><span style = "float:left;margin:5px;font-weight:bold;">请选择评价等级</span><span style="float:right;margin:5px;color:grey;cursor:pointer;" onclick = "gradeBox.hide();">取消</span></div>' +
                ...
                '</div>' +
                '<div id = "grade_advice"><textarea id = "grade_text" style = "width:350px;height:60px;margin:10px;float:left;font-size:15px;border-radius:5px;border:1px solid #ccc;" placeholder = "请说明原因"></textarea>' +
                '</div><button style = "width:80px;height:30px;margin:10px;cursor:pointer;float:right;border-radius:5px;font-size:16px;" onclick = "gradeBox.submit();">提交</button></div>';
